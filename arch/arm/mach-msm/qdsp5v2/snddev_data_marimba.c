...
static struct platform_device *snd_devices_oliver[] __initdata = {
	&msm_iearpiece_device,
	&msm_imic_device,
	&msm_ihs_stereo_rx_device,
	&msm_ihs_mono_rx_device,
...
void __init msm_snddev_init(void)
{
	...
	if (machine_is_msm7x30_ffa() || machine_is_msm8x55_ffa() ||
		...
		(void *) "msm_hsed_config", &snddev_hsed_config_debug_fops);
#endif
	} else if (machine_is_oliver()) {
		platform_add_devices(snd_devices_oliver,
		ARRAY_SIZE(snd_devices_oliver));
	}	
	else
