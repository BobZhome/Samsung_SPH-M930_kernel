...
enum {
	...
	/* PCOM_OEM_SANSUNG_RDM_ASSIGN_CMD: data1 is service, data2 is device */
	/* for meaning of values see modem source code(smem_ext_pc.c) */
	PCOM_OEM_SANSUNG_RDM_GET_SERVICE_CMD,
	PCOM_OEM_SANSUNG_RDM_ASSIGN_CMD,
	PCOM_OEM_SANSUNG_SLEEP_DEBUG_CMD,
	
	PCOM_OEM_LAST = PCOM_OEM_SANSUNG_SLEEP_DEBUG_CMD,
};
