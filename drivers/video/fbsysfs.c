...
#elif CONFIG_FB_MSM_LCDC_S6D05A1_HVGA_PANEL
extern void s6d05a1_sleep_off(void);
extern void s6d05a1_sleep_in(void);
#endif
...
#endif
//	__ATTR(lcd_on_off,S_IRWXU| S_IRWXG |S_IRWXO , NULL, store_lcd_on_off),
	__ATTR(lcd_on_off, S_IRUGO|S_IWUSR, NULL, store_lcd_on_off),
};
