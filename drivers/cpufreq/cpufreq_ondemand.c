		...
		struct input_dev *dev, const struct input_device_id *id)
{
	...
	if(!strcmp(dev->name, "orientation")
		|| !strcmp(dev->name, "accelerometer")
		|| !strcmp(dev->name, "light")
		|| !strcmp(dev->name, "geomagnetic")
		|| !strcmp(dev->name, "geomagnetic_raw")) {
		printk(KERN_ERR "[%s] %s input will not be used to maximize cpufreq\n", __func__, dev->name);
		return -ENODEV;
	}
