...
*/
#define BMA222_WR_FUNC_PTR int (* bma222_bus_write)(unsigned char, unsigned char *)
...
*/
#define BMA222_BUS_WRITE_FUNC(dev_addr, reg_addr, reg_data, wr_len)\
           bma222_bus_write(reg_addr, reg_data)
...
#define BMA222_RD_FUNC_PTR int (* bma222_bus_read)( unsigned char, unsigned char *, unsigned int)
